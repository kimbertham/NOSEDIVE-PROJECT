...
SECRET_KEY = 'nd&-$iv()!xn97b@_$8mx&%f(!tr!%kfy@k^f&z(j%3u1w)r%c'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'my-new-project')]  #Look, we have added the root folder of my-new-project here
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
